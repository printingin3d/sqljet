...
public class SqlJetAssert {
    ...
    public static void assertTrue(boolean value, @Nonnull SqlJetErrorCode errorCode, String message)
    ...
    public static void assertFalse(boolean value, @Nonnull SqlJetErrorCode errorCode, String message)
            throws SqlJetException {
        assertTrue(!value, errorCode, message);
    }

    @SuppressWarnings("null")
    public static @Nonnull <T> T assertNotNull(T value, @Nonnull SqlJetErrorCode errorCode, String message)
            throws SqlJetException {
    ...
    @SuppressWarnings("null")
    public static @Nonnull String assertNotEmpty(String value, @Nonnull SqlJetErrorCode errorCode)
            throws SqlJetException {
        assertTrue(value != null && !value.isEmpty(), errorCode);
        return value;
    }

    public static void assertNotEmpty(String value, @Nonnull SqlJetErrorCode errorCode, String message)
            throws SqlJetException {
    ...
    public static void assertNotEmpty(Collection<?> value, @Nonnull SqlJetErrorCode errorCode, String message)
            throws SqlJetException {
