...
public class SqlJetBtreeCellInfo{
    protected final ISqlJetMemoryPointer pCell;     /* Pointer to the start of cell content */
    private long nKey;      /* The key for INTKEY tables, or number of bytes in key */
    ...
    protected final int iOverflow; /* Offset to overflow page number.  Zero if no overflow */
