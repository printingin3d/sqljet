...
public class SqlJetBtreeDataTable extends SqlJetBtreeTable implements ISqlJetBtreeDataTable {
    ...
    private final @Nonnull ISqlJetBtreeRecord defaults;
    ...
    private void adjustRowIdPosition(@Nonnull Object[] values, @Nonnull Object[] row) {
     ...
     * @throws SqlJetException
     */
    private @Nonnull Object[] getValuesRowForInsert(Object... values) throws SqlJetException {
    ...
    private @Nonnull Object[] getValuesRowForUpdate(Object... values) throws SqlJetException {
        final Object[] row = new Object[tableDef.getColumns().size()];
     ...
     * @throws SqlJetException
     */
    private @Nonnull Object[] getDefaults() throws SqlJetException {
        final Object[] row = new Object[tableDef.getColumns().size()];
    ...
    private long locateSequence() throws SqlJetException {
        ...
        sequenceTable.insert(null, tableDef.getName(), Long.valueOf(newRowId));
        return newRowId;
    }
    ...
    private long updateSequence() throws SqlJetException {
        ...
        sequenceTable.updateCurrent(null, tableDef.getName(), Long.valueOf(newRowId));
        return newRowId;
    }
    ...
    private boolean doActionWithIndexes(Action action, SqlJetConflictAction onConflict, long rowId, Object... row)
        ...
        if (Action.DELETE != action && hasNull(row)) {
            for (ISqlJetColumnDef column : tableDef.getNotNullColumns()) {
        ...
        class IndexKeys {
            final ISqlJetBtreeIndexTable indexTable;
     ...
     * @throws SqlJetException
     */
    private @Nonnull Object[] unwrapValues(Map<String, Object> values) throws SqlJetException {
     ...
     * @throws SqlJetException
     */
    private @Nonnull Object[] unwrapValues(Map<String, Object> values, Object[] defaults) throws SqlJetException {
        int i = 0;
