 ...
 * 
 * <p>
 * The BETWEEN operator is equivalent to a pair of comparisons. "a BETWEEN b AND
 * c" is equivalent to "a&gt;=b AND a&lt;=c". The precedence of the BETWEEN
 * operator is the same as the precedence as operators == and != and LIKE and
