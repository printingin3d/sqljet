...
abstract class Action<T> implements Runnable, ISqlJetTransaction<T, SqlJetDb> {
    ...
    @Override
	abstract public T run(SqlJetDb db) throws SqlJetException;
...
class Creator extends Action<Object> {
...
class Writer extends RepeatedAction<Object> {
...
class Reader extends RepeatedAction<Object> {
